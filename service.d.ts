...
export declare class Service<R extends Resource = Resource> {
    ...
    getPrePath(): string;
    getPath(): string;
    getClone(id: string, params?: IParamsResource): Observable<any>;
    ...
    pathForAll(params?: IParamsCollection): string;
    ...
    static ɵfac: i0.ɵɵFactoryDef<Service<any>>;
    static ɵprov: i0.ɵɵInjectableDef<Service<any>>;
}
