...
/*@__PURE__*/ (function () {
    ɵsetClassMetadata(JsonapiConfig, [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
/*@__PURE__*/ (function () {
    ɵsetClassMetadata(StoreService /* implements IStoreService */, [{
            type: Injectable
        }], function () { return []; }, null);
})();
...
var Core = /** @class */ (function () {
    function Core() {
        ...
        var user_config = JsonapiInjector.get(JsonapiConfig);
        var jsonapiStoreService = JsonapiInjector.get(StoreService);
        var jsonapiHttp = JsonapiInjector.get(Http);
...
NgxJsonapiModule.ɵinj = ɵɵdefineInjector({ factory: function NgxJsonapiModule_Factory(t) { return new (t || NgxJsonapiModule)(); }, providers: [
        ...
        HttpClientModule] });
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(NgxJsonapiModule, { imports: [CommonModule], exports: [
            // BrowserModule,  // needed by HttpClientModule?
            HttpClientModule
        ] });
})();
/*@__PURE__*/ (function () {
    ɵsetClassMetadata(NgxJsonapiModule, [{
            type: NgModule,
            args: [{
                    imports: [CommonModule],
                    exports: [
